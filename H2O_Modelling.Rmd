...
%scala
 // Define SQL JDBC connection parameters  
val sqlEnvironment = "DEV";
val  user = "devdm";
val password = "dev_dm_pa$$w0rd";
val database = "DEV_TPO_UK_MVP";
val server = "bieno-da-d-80173-unilevercom-sqlmi-01.339b4df3d219.database.windows.net:1433";
val jdbcUrlScala = "jdbc:sqlserver://"+server+";database="+database+";user="+user+";password="+password
```
